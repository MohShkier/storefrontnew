  ...
  return (
    <footer className="border-t border-gray-300 bg-gray-100 test">
      <div className="content-container flex flex-col md:flex-row justify-between 2xsmall:max-md:items-center 2xsmall:max-md:justify-center items-start py-10 px-8 lg:px-16 gap-16">
        <div className="flex flex-col items-center lg:items-start space-y-4 lg:space-y-8">
          <LocalizedClientLink href="/" className="flex flex-col items-center lg:flex-col lg:items-center space-y-2 lg:space-y-0 space-x-2 text-xl font-bold text-gray-800 hover:text-orange-500">
            <Image src={logo} className="h-[9rem] w-[9rem]" alt="" />
            <span>المحترف موبايل</span>
          </LocalizedClientLink>

          <ul className="flex justify-center lg:justify-start space-x-4 gap-x-3" dir="rtl">
            <li className="rounded-full bg-yellow-500 text-white w-10 h-10 flex gap-x-5 items-center justify-center ml-4">
              <i className="fab fa-snapchat-ghost"></i>
            </li>
            <li className="rounded-full bg-pink-500 text-white w-10 h-10 flex items-center justify-center mr-4">
              <i className="fab fa-instagram"></i>
            </li>
            <li className="rounded-full bg-blue-600 text-white w-10 h-10 flex items-center justify-center mr-4">
              <i className="fab fa-facebook-f"></i>
            </li>
            <li className="rounded-full bg-blue-700 text-white w-10 h-10 flex items-center justify-center mr-4">
              <i className="fab fa-facebook-messenger"></i>
            </li>
            <li className="rounded-full bg-green-500 text-white w-10 h-10 flex items-center justify-center mr-4">
        ...
        <div className="grid grid-cols-3 2xsmall:max-sm:gap-x-0 gap-x-8 lg:gap-x-16 mt-8 lg:mt-0">
      ...
      <div className="text-sm text-gray-600 text-center py-5">
        © {new Date().getFullYear()} Almohtaref Mobile. All rights reserved.
      </div>
    </footer>
